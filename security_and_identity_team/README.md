...
While SplitNNs are an interesting architectural development, they are far from secure distributed learning method. The issues here are documented in <b><a href="security_and_identity_team/documentation/tools/DoIA/SplitNN/VulnA.pdf">vulnerability A </a></b> and <b><a href="security_and_identity_team/documentation/tools/DoIA/SplitNN/VulnB.pdf"> vulnerability B</a></b>. We are currently working on methods to counter these vulnerabilities.
